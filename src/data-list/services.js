export const services = {
  construction: {
    paragraph:
      "Ejecutamos los proyectos en su totalidad, desde la ingeniería, gestión integral del proyecto, construcción de la obra, logística y supervisión de los trabajos, con el fin de que se realicen de acuerdo a la norma vigente y cumpliendo los plazos de entrega.",
    list: [
      "Obra civil.",
      "Edificación.",
      "Obras de construcción pública y más.",
    ],
  },
  ...
  finishes: {
    ...
    list: [
      ...
      "Detalles de carpintería en madera, aluminio y vidrios de seguridad.",
    ],
  },
